...
Then, I tried adding a particle system but I realized I basically already had one implemented in the *AnimatedSprite* class. I tried adding a grass walk particle thing and although it worked, it looks pretty damn ugly. Check out the commit [here - REMEMBER TO LINK].
